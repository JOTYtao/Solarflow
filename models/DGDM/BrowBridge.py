...
from models.DGDM.Unet3D import Unet3D
...
class BrownianBridgeModel(nn.Module):
    ...
    def p_sample_loop(self, y, context=None, clip_denoised=True, sample_mid_step=False, mix_up=None):
        ...
        if sample_mid_step:
            ...
            for i in tqdm(range(self.truncate_step, len(self.steps)), desc=f'sampling loop time step',
                          total=len(self.steps) - self.truncate_step):
